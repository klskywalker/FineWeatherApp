package com.example.fineweatherapp;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, GetDataFromInternet.AsyncResponse {
    ...
    public void onClick(View v) {
           ...
           // URL url=new URL("http://api.openweathermap.org/data/2.5/weather?q=Yakutsk,ru&APPID=7fc9b89f76b02374478f5695a3603414");
    ...
    private URL buildUrl (String city) {
        ...
        String appid_value="7fc9b89f76b02374478f5695a3603414";
